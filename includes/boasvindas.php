<section id="boas-vindas">
    <div class="min-h-screen px-2 py-2 sm:px-32 sm:pb-30 justify-center  flex flex-col gap-8" id="container">
        <div class="w-full md:max-w-2/3 md:max-w-1/2 2xl:pr-6">
            ...
            <p class="text-lg px-10 md:px-0 md:text-xl leading-[20px]">Tudo isso em uma plataforma acessível de qualquer lugar, moldada para atender às suas necessidades.</p>
        </div>
        <div class="flex gap-6 px-10 md:px-0 text-2xl">
            <button type="button"><a href="login/" class=" px-3 py-2 rounded-lg text-white bg-[#52658c]">Entrar</a></button>
            <button type="button"><a href="mais/" class="border-[2px] border-gray-400 px-3 py-2 rounded-lg text-black">Saiba Mais</a></button>
        </div>
    </div>
</section>